...
python $revizor_src/revizor.py fuzz -s $instructions -c  $SCRIPT_DIR/div-zero.yaml -i 100 -n 100000000 --timeout $TIMEOUT  -w $SCRIPT_DIR/results/violations/ &> $logfile